...
public class MoneyTrasnfer_Adapter extends RecyclerView.Adapter<MoneyTrasnfer_Adapter.SettingViewHolder> {
private Activity mContext;
private final String[] string;
private final int[] Imageid;
        int width;

public MoneyTrasnfer_Adapter(Activity c, String[] string, int[] Imageid) {
        mContext = c;
