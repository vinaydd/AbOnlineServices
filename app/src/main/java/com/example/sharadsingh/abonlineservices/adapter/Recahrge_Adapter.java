...
public class Recahrge_Adapter extends RecyclerView.Adapter<Recahrge_Adapter.SettingViewHolder> {
private Activity mContext;
private final String[] string;
private final int[] Imageid;
        int width;

public Recahrge_Adapter(Activity c, String[] string, int[] Imageid) {
        mContext = c;
